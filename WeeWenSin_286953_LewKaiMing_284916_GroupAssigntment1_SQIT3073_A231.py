...
plt.title('Capital Adequacy Ratio of Life Insurans Company in Year 2023')
plt.xlabel('Quarter')
...
print("General Insurans Company:")
...
plt.ylabel('Quarter')
plt.title('Total Capital Available and Required of General Insurans Company in Year 2023')
plt.legend()
plt.show()
...
plt.axis('equal')
plt.legend()
plt.title('Capital Adequacy Ratio of General Insurans Company in Year 2023')
